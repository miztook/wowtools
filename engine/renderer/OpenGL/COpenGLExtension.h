...
public:
	//general
	void extGlActiveTexture(GLenum texture) const;

	void extGlCompressedTexImage2D(GLenum target, GLint level,
		GLenum internalformat, GLsizei width, GLsizei height,
		GLint border, GLsizei imageSize, const void* data) const;
	void extGlCompressedTexSubImage2D(GLenum target, GLint level, GLint xoffset, GLint yoffset, GLsizei width, GLsizei height, GLenum format, GLsizei imageSize, const GLvoid *data) const;
...
public:
	...
	uint8_t MaxMultipleRTs;

	bool TextureCompressionS3;
	bool TextureCompressionLA;
	bool TextureCompressionRG;
