...
public:
	...
	static void convert4BitTo16Bit(const uint8_t* in, uint16_t* out, int32_t width, int32_t height, const uint32_t* palette, int32_t linepad = 0, bool flip = false);

	static void convert8BitTo16Bit(const uint8_t* in, uint16_t* out, int32_t width, int32_t height, const uint32_t* palette, int32_t linepad = 0, bool flip = false);

	static void convert8BitTo24Bit(const uint8_t* in, uint8_t* out, int32_t width, int32_t height, const uint32_t* palette, int32_t linepad = 0, bool flip = false);
	...
	static void premultiply_A1R5G5B5(void* data, uint32_t width, uint32_t height);
	static void premultiply_A8R8G8B8(void* data, uint32_t width, uint32_t height);
